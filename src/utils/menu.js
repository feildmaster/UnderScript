const menu = (() => {
  ...
  function init() {
    ...
    $('head').append(`<style type="text/css">
        .menu-backdrop { display: none; position: fixed; left: 0; top: 0; width: 100%; height: 100%; overflow: auto; background-color: #000; background-color: rgba(0,0,0,0.4); z-index: 10; }
